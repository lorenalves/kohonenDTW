...
RcppExport SEXP _kohonenDTW_CreateStdDistancePointers(SEXP typesSEXP, SEXP considerNaNsSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _kohonenDTW_CreateStdDistancePointer(SEXP typeSEXP, SEXP considerNaNsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _kohonenDTW_ObjectDistances(SEXP dataSEXP, SEXP numVarsSEXP, SEXP numNAsSEXP, SEXP distanceFunctionsSEXP, SEXP weightsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _kohonenDTW_RcppSupersom(SEXP dataSEXP, SEXP codesSEXP, SEXP numVarsSEXP, SEXP weightsSEXP, SEXP distanceFunctionsSEXP, SEXP numNAsSEXP, SEXP neighbourhoodDistancesSEXP, SEXP neighbourhoodFctSEXP, SEXP alphasSEXP, SEXP radiiSEXP, SEXP numEpochsSEXP, SEXP decaySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type data(dataSEXP);
...
RcppExport SEXP _kohonenDTW_RcppBatchSupersom(SEXP dataSEXP, SEXP codesSEXP, SEXP numVarsSEXP, SEXP weightsSEXP, SEXP distanceFunctionsSEXP, SEXP numNAsSEXP, SEXP neighbourhoodDistancesSEXP, SEXP neighbourhoodFctSEXP, SEXP radiiSEXP, SEXP numEpochsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type data(dataSEXP);
...
RcppExport SEXP _kohonenDTW_RcppParallelBatchSupersom(SEXP dataSEXP, SEXP codesSEXP, SEXP numVarsSEXP, SEXP weightsSEXP, SEXP distanceFunctionsSEXP, SEXP numNAsSEXP, SEXP neighbourhoodDistancesSEXP, SEXP neighbourhoodFctSEXP, SEXP radiiSEXP, SEXP numEpochsSEXP, SEXP numCoresSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type data(dataSEXP);
...
RcppExport SEXP _kohonenDTW_RcppMap(SEXP dataSEXP, SEXP numVarsSEXP, SEXP numNAsSEXP, SEXP codesSEXP, SEXP weightsSEXP, SEXP distanceFunctionsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericMatrix >::type data(dataSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_kohonenDTW_CreateStdDistancePointers", (DL_FUNC) &_kohonenDTW_CreateStdDistancePointers, 2},
    {"_kohonenDTW_CreateStdDistancePointer", (DL_FUNC) &_kohonenDTW_CreateStdDistancePointer, 2},
    {"_kohonenDTW_ObjectDistances", (DL_FUNC) &_kohonenDTW_ObjectDistances, 5},
    {"_kohonenDTW_RcppSupersom", (DL_FUNC) &_kohonenDTW_RcppSupersom, 12},
    {"_kohonenDTW_RcppBatchSupersom", (DL_FUNC) &_kohonenDTW_RcppBatchSupersom, 10},
    {"_kohonenDTW_RcppParallelBatchSupersom", (DL_FUNC) &_kohonenDTW_RcppParallelBatchSupersom, 11},
    {"_kohonenDTW_RcppMap", (DL_FUNC) &_kohonenDTW_RcppMap, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_kohonenDTW(DllInfo *dll) {
